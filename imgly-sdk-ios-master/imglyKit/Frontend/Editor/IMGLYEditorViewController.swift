...
public class IMGLYEditorViewController: UIViewController {
    ...
    private func configureNavigationItems() {
        ...
        buttonDone.frame = CGRectMake(0, 0, 80, 40)
        buttonDone.setImage(UIImage(named: "ww_downarrow", inBundle: bundle, compatibleWithTraitCollection: nil), forState: UIControlState.Normal)
        buttonDone.addTarget(self, action: "tappedDone:", forControlEvents: UIControlEvents.TouchUpInside)
        buttonDone.setTitle("DONE", forState: UIControlState.Normal)
        navigationItem.rightBarButtonItem = UIBarButtonItem(customView: buttonDone)
        
        
        //navigationItem.rightBarButtonItem = UIBarButtonItem(title: "DONE", style: UIBarButtonItemStyle.Done, target: self, action: "tappedDone:")
