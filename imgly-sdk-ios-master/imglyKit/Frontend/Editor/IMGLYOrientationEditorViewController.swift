...
public class IMGLYOrientationEditorViewController: IMGLYSubEditorViewController {
    ...
    public private(set) lazy var rotateLeftButton: IMGLYImageCaptionButton = {
        ...
        button.imageView.image = UIImage(named: "ww_left", inBundle: bundle, compatibleWithTraitCollection: nil)
    ...
    public private(set) lazy var rotateRightButton: IMGLYImageCaptionButton = {
        ...
        button.imageView.image = UIImage(named: "ww_right", inBundle: bundle, compatibleWithTraitCollection: nil)
        button.setTranslatesAutoresizingMaskIntoConstraints(false)
    ...
    public private(set) lazy var flipHorizontallyButton: IMGLYImageCaptionButton = {
        ...
        button.imageView.image = UIImage(named: "ww_horizontal", inBundle: bundle, compatibleWithTraitCollection: nil)
        button.setTranslatesAutoresizingMaskIntoConstraints(false)
    ...
    public private(set) lazy var flipVerticallyButton: IMGLYImageCaptionButton = {
        ...
        button.imageView.image = UIImage(named: "ww_vertical", inBundle: bundle, compatibleWithTraitCollection: nil)
        button.setTranslatesAutoresizingMaskIntoConstraints(false)
