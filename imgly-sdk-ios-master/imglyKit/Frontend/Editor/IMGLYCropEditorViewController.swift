...
public class IMGLYCropEditorViewController: IMGLYSubEditorViewController {
    ...
    public private(set) lazy var freeRatioButton: IMGLYImageCaptionButton = {
        ...
        button.imageView.image = UIImage(named: "ww_custom", inBundle: bundle, compatibleWithTraitCollection: nil)
    ...
    public private(set) lazy var oneToOneRatioButton: IMGLYImageCaptionButton = {
        ...
        button.imageView.image = UIImage(named: "ww_square", inBundle: bundle, compatibleWithTraitCollection: nil)
        button.setTranslatesAutoresizingMaskIntoConstraints(false)
    ...
    public private(set) lazy var fourToThreeRatioButton: IMGLYImageCaptionButton = {
        ...
        button.imageView.image = UIImage(named: "ww_4-3", inBundle: bundle, compatibleWithTraitCollection: nil)
        button.setTranslatesAutoresizingMaskIntoConstraints(false)
    ...
    public private(set) lazy var sixteenToNineRatioButton: IMGLYImageCaptionButton = {
        ...
        button.imageView.image = UIImage(named: "ww_16-9", inBundle: bundle, compatibleWithTraitCollection: nil)
        button.setTranslatesAutoresizingMaskIntoConstraints(false)
